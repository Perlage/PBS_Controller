...
void loop(){
  ...
  if (inPlatformLoop){
    ...
    //run end actions of platformLoop
      ...
      relay4State = LOW; // Don't need this anymore--replaced with platformState
      platformState = HIGH;
  ...
  while(button2State == LOW && switchDoorState == LOW && (P1 >= pressureOffset + pressureDeltaUp) && platformState == HIGH){ 
